...
namespace Aeter.Ratio.Binary.Converters
{
    ...
    {
        public Int16 Convert(Span<byte> value)
        {
            return Convert(value, 0, value.Length);
        }

        public Int16 Convert(Span<byte> value, int startIndex)
        {
            return BinaryPrimitives.ReadInt16LittleEndian(value.Slice(startIndex));
        }

        public Int16 Convert(Span<byte> value, int startIndex, int length)
        {
        ...
        public void Convert(Int16 value, Span<byte> buffer, int offset)
        {
